...
def test_provider_requirements_openprotein_missing_env(
    ...
    monkeypatch.setattr(factory_module.util, "find_spec", _find_spec)
...
def test_provider_requirements_rosettafold_missing_weights_and_docker(
    ...
    factory_module = cast(Any, factory)
    monkeypatch.setattr(
        factory_module.util, "find_spec", lambda _name: SimpleNamespace()
    )
...
def test_require_module_raises_prediction_error(
    ...
    factory_module = cast(Any, factory)
    monkeypatch.setattr(factory_module.util, "find_spec", lambda _name: None)
