...
DEFAULT_CORE_DOMAIN_ENTRIES: tuple[CoreDomainFamilyEntry, ...] = (
    ...
    CoreDomainFamilyEntry(
        ...
        required_modules=(
            ...
            "identification/adapters/fragpipe_import.py",
    ...
    CoreDomainFamilyEntry(
        ...
        required_modules=(
            ...
            "quantification/statistics/differential_result_robustness.py",
            ...
            "quantification/provenance/sample_exploration.py",
    ...
    CoreDomainFamilyEntry(
        ...
        required_modules=(
            ...
            "workflow/biological_report_html.py",
            "workflow/biological_report_html_support.py",
            "workflow/biological_report_models.py",
            "workflow/biological_report_ranking.py",
            "workflow/biological_report_rendering.py",
            "workflow/biological_report_section_confidence.py",
            "workflow/biological_report_selection.py",
            ...
            "workflow/public_benchmark_subset.py",
