"""Synthesis workflow owners grouped by cross-study and report assembly surfaces."""
...
__all__, _SYNTHESIS_PIPELINE_EXPORT_INDEX = build_lazy_export_index(
...
def __getattr__(name: str) -> Any:
    return resolve_public_export(
        __name__,
        globals(),
        _SYNTHESIS_PIPELINE_EXPORT_INDEX,
        name,
    )
