...
def write_biological_activity_exports(
    ...
    (
        compartment_summary_name,
        compartment_enrichment_name,
        ...
        compartment_unknown_name,
    ) = _write_biological_compartment_activity_exports(report, output_dir)
    (
        pathway_card_name,
        pathway_activity_summary_name,
        pathway_activity_matrix_name,
        pathway_activity_sample_name,
        pathway_activity_condition_name,
        pathway_activity_comparison_name,
        pathway_activity_member_name,
        pathway_activity_unresolved_name,
    ) = _write_biological_pathway_activity_exports(report, output_dir)
    (
        complex_activity_summary_name,
        complex_activity_matrix_name,
        complex_activity_sample_name,
        complex_activity_condition_name,
        complex_activity_comparison_name,
        complex_activity_member_name,
        complex_activity_unresolved_name,
    ) = _write_biological_complex_activity_exports(report, output_dir)
