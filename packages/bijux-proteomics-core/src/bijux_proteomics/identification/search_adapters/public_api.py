...
_SEARCH_ADAPTER_PUBLIC_EXPORTS: tuple[tuple[str, str], ...] = (
    ...
    (
        ...
        "bijux_proteomics.identification.search_adapters.contracts",
    ),
    (
    ...
    (
        ...
        "bijux_proteomics.identification.search_adapters.corpus",
    ),
    (
    ...
    (
        ...
        "bijux_proteomics.identification.search_adapters.comparison",
    ),
    (
        "assess_search_result_input",
        "bijux_proteomics.identification.search_adapters.input_review",
    ),
    ("build_calibration_plot_data", "bijux_proteomics.identification.contracts"),
    (
        "build_comet_output_corpus_report",
        "bijux_proteomics.identification.search_adapters.engines.comet",
    ),
    (
        "build_diann_output_corpus_report",
        "bijux_proteomics.identification.search_adapters.engines.diann",
    ),
    (
    ...
    (
        ...
        "bijux_proteomics.identification.search_adapters.engines.maxquant",
    ),
    (
        "build_msfragger_output_corpus_report",
        "bijux_proteomics.identification.search_adapters.engines.msfragger",
    ),
    (
        "build_sage_output_corpus_report",
        "bijux_proteomics.identification.search_adapters.engines.sage",
    ),
    (
        "build_search_adapter_capability_matrix",
        "bijux_proteomics.identification.search_adapters.registry",
    ),
    (
        "build_search_adapter_conformance_report",
        "bijux_proteomics.identification.search_adapters.conformance",
    ),
    (
        "build_search_adapter_corpus_conformance_matrix",
        "bijux_proteomics.identification.search_adapters.corpus_matrix",
    ),
    (
    ...
    (
        ...
        "bijux_proteomics.identification.search_adapters.regression",
    ),
    (
    ...
    (
        ...
        "bijux_proteomics.identification.search_adapters.family_policy",
    ),
    (
        "build_spectronaut_output_corpus_report",
        "bijux_proteomics.identification.search_adapters.engines.spectronaut",
    ),
    (
        "compare_search_parameters",
        "bijux_proteomics.identification.search_adapters.parameter_review",
    ),
    (
    ...
    (
        ...
        "bijux_proteomics.identification.search_adapters.normalization",
    ),
