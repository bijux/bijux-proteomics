...
CORE_LINE_COUNT_EXCEPTIONS = (
    ...
    _exception("interpretation/complex_activity.py", 1055),
    _exception("interpretation/pathway_activity.py", 1047),
    _exception("interpretation/protein_set_scoring/analysis.py", 1012),
