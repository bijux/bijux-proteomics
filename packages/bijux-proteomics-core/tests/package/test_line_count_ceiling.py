...
CORE_LINE_COUNT_EXCEPTIONS = (
    ...
    _exception("interpretation/pathway_activity.py", 1019),
    _exception("interpretation/regulator_inference.py", 1418),
    ...
    _exception("quantification/provenance/sample_exploration.py", 1206),
    _exception("quantification/rollup/protein_lfq.py", 1113),
    _exception("quantification/statistics/differential_abundance.py", 1487),
