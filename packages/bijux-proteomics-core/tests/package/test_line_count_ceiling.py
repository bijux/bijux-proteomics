...
CORE_LINE_COUNT_EXCEPTIONS = (
    ...
    _exception("chemistry/contracts.py", 2194),
    ...
    _exception("interfaces/support/__init__.py", 1144),
    ...
    _exception("interpretation/regulator_inference.py", 1457),
    ...
    _exception("quantification/statistics/differential_result_robustness.py", 1111),
    ...
    _exception("sequences/protein_region_context.py", 1210),
