...
CORE_LINE_COUNT_EXCEPTIONS = (
    _exception("_scientific_tables.py", 1057),
    ...
    _exception("chemistry/contracts.py", 2190),
    ...
    _exception("interfaces/support/__init__.py", 1143),
    _exception("interfaces/support/biomarker_candidate_support.py", 1601),
    _exception("interfaces/support/output_protocol.py", 1232),
    _exception("interfaces/support/sequence_support.py", 1419),
    _exception("interfaces/support/targeted_panel_support.py", 1683),
    _exception("interfaces/support/targeted_selection_io.py", 1597),
    _exception("interfaces/support/validation_evidence_support.py", 1531),
    _exception("interpretation/complex_activity.py", 1027),
    _exception("interpretation/pathway_activity.py", 1024),
    _exception("interpretation/regulator_inference.py", 1424),
    _exception("io/formats/proteomics_formats.py", 1074),
    _exception("io/raw/raw_signal_evidence_cards.py", 1114),
    _exception("io/spectra/spectrum_contracts.py", 2093),
    _exception("lab/qc.py", 2174),
    _exception("ptm/cards/evidence_cards.py", 1400),
    _exception("ptm/contracts.py", 1052),
    _exception("ptm/quant/differential_analysis.py", 1071),
    _exception("quantification/matrix/peptide_intensity_matrix.py", 1026),
    _exception("quantification/missingness/missingness.py", 1114),
    _exception("quantification/provenance/review.py", 1386),
    _exception("quantification/provenance/sample_exploration.py", 1210),
    _exception("quantification/rollup/protein_lfq.py", 1113),
    _exception("quantification/statistics/differential_abundance.py", 1502),
    ...
    _exception("review/explanations/result_explanations.py", 1331),
    _exception("sequences/core.py", 1340),
    _exception("sequences/digestion.py", 1198),
    _exception("sequences/protein_region_context.py", 1171),
    _exception("targeted/assay_interference.py", 1079),
    _exception("targeted/assay_qc.py", 1258),
    _exception("targeted/biomarker_stability.py", 1080),
    _exception("workflow/cards/protein_evidence_cards.py", 1433),
    _exception("workflow/cross_study_effect_comparison.py", 1146),
    _exception("workflow/cross_study_pathway_comparison.py", 1121),
    _exception("workflow/cross_study_protein_harmonization.py", 1120),
    _exception("workflow/exports/interactive_result_bundle.py", 1356),
    _exception("workflow/pipelines/advanced_tmt.py", 1012),
    _exception("workflow/pipelines/dia_dda_comparison.py", 1215),
    _exception("workflow/pipelines/label_based_differential_analysis.py", 1297),
    _exception("workflow/pipelines/orchestrator.py", 1089),
    _exception("workflow/pipelines/public_benchmark_runner.py", 1134),
    _exception("workflow/reports/biological_report_assembly.py", 1003),
    _exception("workflow/study_result.py", 1432),
)
