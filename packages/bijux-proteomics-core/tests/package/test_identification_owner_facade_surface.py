...
def test_search_adapter_subfacade_keeps_canonical_adapter_exports() -> None:
    ...
    assert hasattr(search_adapters, "build_search_adapter_capability_matrix")
    assert hasattr(search_adapters, "get_search_adapter_manifest")
    ...
    assert not hasattr(identification, "build_search_adapter_capability_matrix")
    assert not hasattr(identification, "get_search_adapter_manifest")
