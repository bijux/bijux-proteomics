...
def test_apply_pathway_enrichment_multiple_testing_counts_enriched_entries() -> None:
    ...
    permissive = apply_pathway_enrichment_multiple_testing(
        report,
    ...
    strict = apply_pathway_enrichment_multiple_testing(
        report,
        policy=PathwayEnrichmentCorrectionPolicy(
    ...
    assert permissive.summary.enriched_entry_count == 5
