...
def test_ptm_lab_validation_packet_includes_assay_risk_controls_and_evidence_needs() -> None:
    ...
    high_risk = next(entry for entry in packet.entries if entry.assay_risk.value == "high")
