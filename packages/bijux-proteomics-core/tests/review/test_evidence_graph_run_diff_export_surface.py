...
from bijux_proteomics.review import compare_evidence_graph_runs, render_evidence_graph_run_diff_tsv
...
def test_evidence_graph_run_diff_renders_scientific_change_tsv() -> None:
    ...
    assert "category\tchange_kind\tentity_ref\tleft_claim_state\tright_claim_state" in rendered
