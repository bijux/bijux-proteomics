    ...
    *,
    ...
    if ready_for_synthesis and not blocking_findings:
        return CandidateLabAdvancementDecision(
            ...
            reasons=["decision brief is ready for lab execution"],
            follow_up_actions=recommended_actions,
            audit_trail=(
                "decision brief is synthesis-ready",
    ...
    return CandidateLabAdvancementDecision(
        ...
        evidence_ids=evidence_ids,
        reasons=blocking_findings or ["decision brief is not ready for lab execution"],
        follow_up_actions=recommended_actions,
        audit_trail=(
            "decision brief is not synthesis-ready",
