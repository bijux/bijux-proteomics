...
def _required_benchmark_manifest() -> BenchmarkManifest:
...
def _supported_benchmark_report() -> TargetedBenchmarkReport:
    ...
    return build_targeted_benchmark_report(
        benchmark_manifest=_required_benchmark_manifest(),
