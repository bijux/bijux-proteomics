...
def _supported_benchmark_report(*, cache_age_days: int) -> TargetedBenchmarkReport:
...
def test_build_targeted_benchmark_report_connects_discovery_evidence_to_lab_outputs() -> (
    ...
    report = _supported_benchmark_report(cache_age_days=7)
...
def test_targeted_benchmark_report_separates_partial_support_from_strong_support() -> (
    ...
    report = _supported_benchmark_report(cache_age_days=45)
