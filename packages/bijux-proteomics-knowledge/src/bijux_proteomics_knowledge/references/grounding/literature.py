...
DEFAULT_LITERATURE_GROUPS: tuple[LiteratureGroup, ...] = (
    LiteratureGroup(
        ...
        version_trace=(
            "This literature cluster was reviewed against its linked benchmark and context surfaces on 2026-05-05.",
        ),
        retrieval_trace=(
            "The linked citations, context ids, and benchmark ids were re-verified on 2026-05-05.",
        ),
