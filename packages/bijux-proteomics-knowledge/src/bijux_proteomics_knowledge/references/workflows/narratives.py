...
DEFAULT_WORKFLOW_NARRATIVES: tuple[WorkflowNarrative, ...] = (
    WorkflowNarrative(
        ...
        version_trace=(
            "Narrative wording was reviewed against the linked benchmark and reference surfaces on 2026-05-05.",
        ),
        retrieval_trace=(
            "The linked benchmark ids, citation ids, context ids, and problem ids were re-verified on 2026-05-05.",
        ),
