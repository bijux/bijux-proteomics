...
from bijux_proteomics_dev.api.package_readme_maturity import build_package_readme_maturity_report
from bijux_proteomics_dev.api.package_root_surface_illusions import (
    build_package_root_surface_illusion_report,
)
from bijux_proteomics_dev.api.package_topology_drift import build_package_topology_drift_report
...
def _toml_text(report: PackageReopenedCompletionClaimReport) -> str:
    lines = [
        ...
        "# Regenerate with: ./.venv/bin/python -m bijux_proteomics_dev.api.package_reopened_completion_claims",
        "",
        "[guard]",
