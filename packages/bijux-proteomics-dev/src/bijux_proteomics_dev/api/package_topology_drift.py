...
from bijux_proteomics_dev.api.package_document_contracts import module_topology_tokens
...
def _toml_text(report: PackageTopologyDriftReport) -> str:
    lines = [
        ...
        "# Regenerate with: ./.venv/bin/python -m bijux_proteomics_dev.api.package_topology_drift",
        "",
        "[guard]",
