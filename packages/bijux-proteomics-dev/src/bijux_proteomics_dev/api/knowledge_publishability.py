...
from bijux_proteomics_dev.api.knowledge_breadth import (
    KNOWLEDGE_BREADTH_PATH,
    build_knowledge_breadth_report,
    validate_knowledge_breadth,
)
from bijux_proteomics_dev.api.knowledge_reference_quality import (
...
def _toml_text(report: KnowledgePublishabilityReport) -> str:
    ...
    return "\n".join(
        (
            ...
            "# Regenerate with: ./.venv/bin/python -m bijux_proteomics_dev.api.knowledge_publishability",
            "",
            "[metrics]",
