...
from bijux_proteomics_dev.api.foundation_kernel_boundaries import (
...
from bijux_proteomics_dev.api.public_surfaces import (
...
def _toml_text(report: FoundationPublishabilityReport) -> str:
    ...
    return "\n".join(
        (
            ...
            "# Regenerate with: ./.venv/bin/python -m bijux_proteomics_dev.api.foundation_publishability",
            "",
            "[metrics]",
