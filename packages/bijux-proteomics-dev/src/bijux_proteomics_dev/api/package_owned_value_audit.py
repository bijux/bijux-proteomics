...
from bijux_proteomics_dev.api.package_document_contracts import (
    boundary_doc_path,
    markdown_bullets,
    section_lines,
    readme_path,
)
from bijux_proteomics_dev.api.package_surface_pressure import build_package_surface_pressure_report
...
def _toml_text(report: PackageOwnedValueAuditReport) -> str:
    lines = [
        ...
        "# Regenerate with: ./.venv/bin/python -m bijux_proteomics_dev.api.package_owned_value_audit",
        "",
        "[guard]",
