...
def knowledge_surfaces() -> tuple[PublicKnowledgeSurface, ...]:
    ...
    return (
        ...
        PublicKnowledgeSurface("bijux_proteomics_knowledge.memory.evidence"),
        PublicKnowledgeSurface("bijux_proteomics_knowledge.memory.graph"),
...
def _toml_text(entries: tuple[KnowledgeSurfaceConsumerEntry, ...]) -> str:
    lines = [
        ...
        "# Regenerate with: ./.venv/bin/python -m bijux_proteomics_dev.api.knowledge_surface_consumers",
        "",
    ]
