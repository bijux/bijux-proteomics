...
from bijux_proteomics_dev.api.package_owned_value_audit import build_package_owned_value_audit_report
from bijux_proteomics_dev.api.package_release_dossiers import build_package_release_dossier_report
from bijux_proteomics_dev.api.package_scorecard import build_package_scorecard_report
from bijux_proteomics_dev.api.package_document_contracts import readme_path
...
def _toml_text(report: PackageReadmeMaturityReport) -> str:
    lines = [
        ...
        "# Regenerate with: ./.venv/bin/python -m bijux_proteomics_dev.api.package_readme_maturity",
        "",
        "[guard]",
