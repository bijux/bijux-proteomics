...
from bijux_proteomics_dev.api.foundation.kernel_boundaries import (
    FOUNDATION_KERNEL_BOUNDARIES_PATH,
    build_foundation_kernel_boundaries,
    validate_foundation_kernel_boundaries,
)
from bijux_proteomics_dev.api.foundation.root_consumers import (
    REPO_ROOT,
    build_foundation_root_consumers,
)
from bijux_proteomics_dev.api.foundation.size_reuse import (
    FOUNDATION_SIZE_REUSE_PATH,
    build_foundation_size_reuse_report,
    validate_foundation_size_reuse,
)
from bijux_proteomics_dev.api.package_shape.public_surfaces import (
...
def _toml_text(report: FoundationPublishabilityReport) -> str:
    ...
    return "\n".join(
        (
            ...
            "# Regenerate with: ./.venv/bin/python -m bijux_proteomics_dev.api.foundation.publishability",
            "",
            "[metrics]",
