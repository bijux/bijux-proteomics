...
from bijux_proteomics_dev.api.support.workspace_import_inventory import (
...
def _toml_text(report: ModuleDependencyGraphReport) -> str:
    lines = [
        ...
        "# Regenerate with: ./.venv/bin/python -m bijux_proteomics_dev.api.dependencies.module_dependency_graphs",
        "",
