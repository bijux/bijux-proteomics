...
from bijux_proteomics_dev.api.dependencies.package_dependency_graph import (
    build_package_dependency_graph_report,
)
from bijux_proteomics_dev.api.dependencies.package_dependency_policy import (
    build_package_dependency_policy_report,
)
from bijux_proteomics_dev.api.support.workspace_inventory import workspace_package_names
...
def _toml_text(report: PackageDependencyDossierReport) -> str:
    lines = [
        ...
        "# Regenerate with: ./.venv/bin/python -m bijux_proteomics_dev.api.dependencies.package_dependency_dossiers",
        "",
    ]
    for entry in report.entries:
        lines.extend(
