...
from bijux_proteomics_dev.api.lab.analytical_logic import validate_lab_analytical_logic
from bijux_proteomics_dev.api.lab.core_scientific_semantics import (
...
from bijux_proteomics_dev.api.lab.operational_ownership import (
    LAB_OPERATIONAL_OWNERSHIP_PATH,
    build_lab_operational_ownership_report,
    validate_lab_operational_ownership,
)
from bijux_proteomics_dev.api.lab.packet_only_modules import (
    LAB_PACKET_ONLY_MODULES_PATH,
    validate_lab_module_shapes,
)
from bijux_proteomics_dev.api.lab.root_imports import (
    LAB_ROOT_IMPORTS_PATH,
    validate_lab_root_imports,
)
from bijux_proteomics_dev.api.lab.runtime_boundary_drift import (
...
def _toml_text(report: LabPublishabilityReport) -> str:
    ...
    return "\n".join(
        (
            ...
            "# Regenerate with: ./.venv/bin/python -m bijux_proteomics_dev.api.lab.publishability",
            "",
            "[metrics]",
