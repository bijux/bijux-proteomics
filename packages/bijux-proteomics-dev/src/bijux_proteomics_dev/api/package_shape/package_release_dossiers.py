...
from bijux_proteomics_dev.api.support.workspace_inventory import package_root, workspace_package_names
...
def _toml_text(report: PackageReleaseDossierReport) -> str:
    lines = [
        ...
        "# Regenerate with: ./.venv/bin/python -m bijux_proteomics_dev.api.package_shape.package_release_dossiers",
        "",
    ]
    for entry in report.entries:
        lines.extend(
