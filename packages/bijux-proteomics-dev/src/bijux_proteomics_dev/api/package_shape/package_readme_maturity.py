...
from bijux_proteomics_dev.api.package_shape.package_owned_value_audit import build_package_owned_value_audit_report
from bijux_proteomics_dev.api.package_shape.package_release_dossiers import build_package_release_dossier_report
...
def _toml_text(report: PackageReadmeMaturityReport) -> str:
    lines = [
        ...
        "# Regenerate with: ./.venv/bin/python -m bijux_proteomics_dev.api.package_shape.package_readme_maturity",
        "",
        "[guard]",
