...
from bijux_proteomics_dev.api.package_shape.package_root_line_counts import (
...
def _toml_text(report: PackageRootBudgetReport) -> str:
    ...
    lines = [
        ...
        "# Regenerate with: ./.venv/bin/python -m bijux_proteomics_dev.api.package_shape.package_root_budgets",
        "",
