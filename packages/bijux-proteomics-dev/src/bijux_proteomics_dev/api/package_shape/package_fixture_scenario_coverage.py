...
from bijux_proteomics_dev.api.package_shape.package_fixture_realism import (
...
def _toml_text(report: PackageFixtureScenarioCoverageReport) -> str:
    lines = [
        ...
        "# Regenerate with: ./.venv/bin/python -m bijux_proteomics_dev.api.package_shape.package_fixture_scenario_coverage",
        "",
        "[guard]",
