...
from bijux_proteomics_dev.api.package_shape.package_module_ledger import build_package_module_ledger_report
from bijux_proteomics_dev.api.package_shape.public_symbol_ledger import build_public_symbol_ledger_report
...
def _toml_text(report: PackageSurfacePressureReport) -> str:
    lines = [
        ...
        "# Regenerate with: ./.venv/bin/python -m bijux_proteomics_dev.api.package_shape.package_surface_pressure",
        "",
        "[guard]",
