...
from bijux_proteomics_dev.api.foundation.root_consumers import REPO_ROOT, downstream_packages
...
def _toml_text(report: CoreCompatibilityExportReport) -> str:
    lines = [
        ...
        "# Regenerate with: ./.venv/bin/python -m bijux_proteomics_dev.api.core.compatibility_exports",
        "",
        "[guard]",
