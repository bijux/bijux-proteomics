...
from bijux_proteomics_dev.governance.lab.cross_package_dependencies import (
    LAB_CROSS_PACKAGE_DEPENDENCIES_PATH,
    validate_lab_cross_package_dependencies,
)
from bijux_proteomics_dev.governance.lab.operational_ownership import (
    LAB_OPERATIONAL_OWNERSHIP_PATH,
    build_lab_operational_ownership_report,
    validate_lab_operational_ownership,
)
from bijux_proteomics_dev.governance.lab.packet_only_modules import (
...
def _toml_text(report: LabPublishabilityReport) -> str:
    ...
    return "\n".join(
        (
            ...
            "# Regenerate with: ./.venv/bin/python -m bijux_proteomics_dev.governance.lab.publishability",
            "",
            "[metrics]",
