...
def test_family_lineage_docs_and_core_indexes_link_to_audit_surfaces() -> None:
    ...
    flagship_status = _read_core_doc("benchmark-flagship-status.md")
    ...
    assert "# Benchmark Flagship Status" in flagship_status
    assert "generalization_companion" in flagship_status
    assert "flagship_primary_internal_support" in flagship_status
    ...
    assert "Benchmark Flagship Status" in foundation_index
    ...
    assert "Benchmark Flagship Status" in asset_handbook
