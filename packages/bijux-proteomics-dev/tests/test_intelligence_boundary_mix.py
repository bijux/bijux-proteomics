...
from bijux_proteomics_dev.api.intelligence_boundary_mix import (
...
def test_intelligence_boundary_mix_report_tracks_governed_hotspots() -> None:
    ...
    assert metrics.scanned_module_count == 15
    ...
    assert guard.baseline_hotspot_modules == ("decision_paths.py",)
