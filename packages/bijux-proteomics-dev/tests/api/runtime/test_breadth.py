...
from bijux_proteomics_dev.api.runtime.breadth import (
...
def test_runtime_breadth_report_pairs_surface_growth_with_owned_logic() -> None:
    ...
    assert metrics.owner_execution_module_count == 125
    assert metrics.owner_execution_modules_per_surface >= 4.8
