...
def test_runtime_provider_ownership_dossier_covers_live_provider_owners_tests_and_fixtures() -> None:
    _assert_doc_references_live_paths(
        ...
        required_references=(
            "src/bijux_proteomics_runtime/providers/base.py",
            "src/bijux_proteomics_runtime/providers/errors.py",
            "src/bijux_proteomics_runtime/providers/capabilities.py",
            "src/bijux_proteomics_runtime/providers/factory.py",
            "src/bijux_proteomics_runtime/providers/support.py",
            "src/bijux_proteomics_runtime/providers/heuristic.py",
            "src/bijux_proteomics_runtime/providers/local/esmfold.py",
            "src/bijux_proteomics_runtime/providers/local/rosettafold.py",
            "src/bijux_proteomics_runtime/providers/experimental/colabfold.py",
            "src/bijux_proteomics_runtime/providers/experimental/openprotein.py",
            "src/bijux_proteomics_runtime/providers/experimental/_async_utils.py",
            "tests/test_runtime_provider_surface.py",
            "tests/test_provider_capability_validation.py",
            "tests/test_provider_capability_registry_surface.py",
            "tests/test_runtime_execution_conformance.py",
            "tests/conftest.py",
            "tests/fixtures/execution/sequence_review_path.json",
...
def test_runtime_artifact_lineage_dossier_covers_live_owner_code_tests_and_fixtures() -> None:
    _assert_doc_references_live_paths(
        ...
        required_references=(
            ...
            "src/bijux_proteomics_runtime/runtime/workspace.py",
            ...
            "tests/test_runtime_context_contracts.py",
            "tests/test_runtime_transport_contracts.py",
            "tests/test_runtime_artifact_ledger.py",
            "tests/test_runtime_integrity_surface.py",
            "tests/test_runtime_import_surface.py",
            "tests/test_runtime_replay_bundle.py",
            "tests/test_runtime_replay_integrity_and_cache_end_to_end.py",
            "tests/test_runtime_rerun_planning.py",
            "tests/test_runtime_execution_bundles.py",
            "tests/test_runtime_container_and_scheduler_end_to_end.py",
            "tests/test_runtime_workflow_paths.py",
            "tests/test_runtime_replay_decision_reports.py",
            "tests/test_runtime_execution_decision_reports.py",
            "tests/test_runtime_cleanup_and_recovery.py",
            "tests/test_runtime_failure_and_preflight.py",
            "tests/fixtures/execution/sequence_review_path.json",
