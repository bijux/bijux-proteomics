...
from bijux_proteomics_dev.governance.package_shape.package_thin_modules import (
...
def test_package_thin_module_report_tracks_current_merge_or_delete_follow_up() -> None:
    ...
    assert any(
        path.endswith("agents/analysis/failure_analysis.py") for path in module_paths
    )
