...
from bijux_proteomics_dev.api.core_cross_package_imports import (
...
def test_core_cross_package_import_report_tracks_live_edges() -> None:
    ...
    assert "execution/runtime_adapter.py" in importers
    assert "workflow/runtime_bundles.py" in importers
