...
_CANONICAL_PACKAGE = "bijux_proteomics_lab"
...
__version__ = alias_package_version("proteomics-lab")
__all__ = ["__version__"]


def __getattr__(name: str) -> Any:
    """Forward top-level compatibility lookups to the canonical lab package."""

    return getattr(import_module(_CANONICAL_PACKAGE), name)


def __dir__() -> list[str]:
    """Expose canonical lab attributes in interactive discovery."""
