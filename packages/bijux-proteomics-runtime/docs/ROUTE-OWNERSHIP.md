...
- owner tests: `tests/api/test_runtime_execution_route_surface.py`, `tests/api/test_runtime_api_surface.py`
- owner fixtures: `tests/fixtures/api/run_history_response.json`, `tests/support/fixture_data.py`
...
- endpoint wiring: `src/bijux_proteomics_runtime/api/v1/endpoints/runtime_contracts.py`
- owner tests: `tests/api/test_quant_report_route_surface.py`
- owner fixtures: `tests/support/fixture_data.py`
...
- endpoint wiring: `src/bijux_proteomics_runtime/api/v1/endpoints/runtime_contracts.py`
- owner tests: `tests/api/test_ptm_report_route_surface.py`
- owner fixtures: `tests/support/fixture_data.py`
...
- endpoint wiring: `src/bijux_proteomics_runtime/api/v1/endpoints/runtime_contracts.py`
- owner tests: `tests/api/test_evidence_graph_query_route_surface.py`
...
- endpoint wiring: `src/bijux_proteomics_runtime/api/v1/endpoints/runtime_contracts.py`
- owner tests: `tests/api/test_lab_handoff_route_surface.py`
- owner fixtures: `tests/support/fixture_data.py`
...
- endpoint wiring: `src/bijux_proteomics_runtime/api/v1/endpoints/runtime_contracts.py`
- owner tests: `tests/api/test_adapter_conformance_route_surface.py`
- owner fixtures: `tests/support/fixture_data.py`
