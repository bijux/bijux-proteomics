...
- owner tests: `tests/test_runtime_context_contracts.py`, `tests/test_runtime_transport_contracts.py`
...
- owner tests: `tests/test_runtime_artifact_ledger.py`, `tests/test_runtime_integrity_surface.py`
...
- owner tests: `tests/test_runtime_import_surface.py`, `tests/test_runtime_local_and_import_end_to_end.py`
...
- owner tests: `tests/test_runtime_replay_bundle.py`, `tests/test_runtime_replay_integrity_and_cache_end_to_end.py`, `tests/test_runtime_rerun_planning.py`
...
- owner tests: `tests/test_runtime_execution_bundles.py`, `tests/test_runtime_container_and_scheduler_end_to_end.py`, `tests/test_runtime_workflow_paths.py`
...
- owner tests: `tests/test_runtime_replay_decision_reports.py`, `tests/test_runtime_execution_decision_reports.py`, `tests/test_runtime_cleanup_and_recovery.py`, `tests/test_runtime_failure_and_preflight.py`
