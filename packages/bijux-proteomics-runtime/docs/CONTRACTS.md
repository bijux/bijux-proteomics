...
- `bijux_proteomics_runtime.api.cli:cli` is the flagship workflow CLI entrypoint.
...
- HTTP route ownership is pinned to `api/routes/runtime_execution.py`, `decision_briefs.py`, `quant_reports.py`, `ptm_reports.py`, `evidence_graph.py`, `lab_handoffs.py`, and `adapter_conformance.py`
