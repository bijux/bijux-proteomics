...
BIJUX_PY_REQUIRED_FILES ?= api.mk build.mk docs.mk help.mk lint.mk package-api-python.mk package-gates.mk package-profile.mk package-python.mk package-workspace-python.mk quality.mk repository-env.mk repository-publish.mk root-env.mk root-lifecycle.mk sbom.mk security.mk util.mk
