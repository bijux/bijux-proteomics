...
BIJUX_STD_CHECK_SCRIPT ?= $(if $(wildcard .bijux/shared/bijux-checks/check-bijux-std.sh),.bijux/shared/bijux-checks/check-bijux-std.sh,shared/bijux-checks/check-bijux-std.sh)
BIJUX_STD_UPDATE_SCRIPT ?= $(if $(wildcard .bijux/shared/bijux-checks/update-bijux-std.sh),.bijux/shared/bijux-checks/update-bijux-std.sh,shared/bijux-checks/update-bijux-std.sh)
BIJUX_STD_REF ?= main
