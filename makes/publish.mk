...
.PHONY: publish publish-test twine twine-check twine-upload twine-upload-test ensure-dists verify-test-install
...
twine-upload: ensure-dists
	@echo "→ Uploading $(PUBLISH_PACKAGE_NAME) to repository '$(TWINE_REPOSITORY)'"
...
verify-test-install:
	...
	$(UV) pip install --python "$$tmp/venv/bin/python" -i https://test.pypi.org/simple --extra-index-url https://pypi.org/simple "$(PUBLISH_PACKAGE_NAME)"; \
