...
ROOT_ARTIFACT_SETUP_COMMAND = PYTHONPATH="$(CURDIR)/packages/bijux-proteomics-dev/src$${PYTHONPATH:+:$$PYTHONPATH}" "$(PYTHON)" -m bijux_proteomics_dev.workspace.artifact_layout
