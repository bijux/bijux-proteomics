...
## Contracts  
Core modules live under [packages/agentic-proteins/src/agentic_proteins/core](https://github.com/bijux/agentic-proteins/blob/main/packages/agentic-proteins/src/agentic_proteins/core).  
Sandbox modules live under [packages/agentic-proteins/src/agentic_proteins/sandbox](https://github.com/bijux/agentic-proteins/blob/main/packages/agentic-proteins/src/agentic_proteins/sandbox/__init__.py).  
...
Code refs: [packages/agentic-proteins/src/agentic_proteins/sandbox/__init__.py](https://github.com/bijux/agentic-proteins/blob/main/packages/agentic-proteins/src/agentic_proteins/sandbox/__init__.py).  
