...
`bijux-proteomics-core` should depend on neighboring packages only in ways that strengthen
its role as durable program contracts. Adjacency is acceptable when it clarifies handoff and
