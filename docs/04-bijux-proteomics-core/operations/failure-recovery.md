...
flowchart LR
    ...
    signal3["change docs"]
    page["bijux-proteomics-core<br/>failure recovery"]
...
- interface surfaces: CLI entrypoint in src/bijux_proteomics/interfaces/cli.py, HTTP app in src/bijux_proteomics/programs.py, program schemas in src/bijux_proteomics/programs.py
