...
Reviewing changes in `bijux-proteomics-core` should include both behavior and documentation.
...
flowchart LR
    ...
    page["bijux-proteomics-core<br/>review checklist"]
...
Use `Review Checklist` to decide whether `bijux-proteomics-core` has actually earned trust after a change. If one narrow green check hides a wider contract, risk, or validation gap, the work is not done yet.
