...
Compatibility in `bijux-proteomics-core` should be explicit: stable commands, tracked schemas,
...
```mermaid
flowchart LR
    contract1["program schema"]
    contract2["lifecycle rules"]
    contract3["readiness contracts"]
    page["bijux-proteomics-core<br/>compatibility commitments"]
    proof1["package code"]
    proof2["tests"]
    proof3["contract docs"]
