...
- `outsider_review:ptm` is complete enough to count as an outsider-auditable
  flagship family.
...
- comparator and ambiguity limits remain visible
- the repo does not flatten PTM excitement into promotion language
- the tracked public package keeps localization, feature, FASTA, and
