...
```mermaid
flowchart LR
    up1["recommended work"]
    up2["readiness state"]
    up3["assay dependencies"]
    page["bijux-proteomics-lab<br/>dependency direction"]
    down1["knowledge evidence updates"]
    down2["runtime execution records"]
    down3["next-cycle planning"]
