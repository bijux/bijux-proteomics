...
Deployment for `bijux-proteomics-lab` should respect the package boundary instead of assuming the full repository is always present.
...
This page shows how `bijux-proteomics-lab` is run and reviewed without forcing readers to reconstruct the workflow from logs or oral history.
...
flowchart LR
    ...
    page["bijux-proteomics-lab<br/>deployment boundaries"]
...
- package root: `packages/bijux-proteomics-lab`
- public metadata: `packages/bijux-proteomics-lab/pyproject.toml`
- release notes: `packages/bijux-proteomics-lab/CHANGELOG.md` when present
