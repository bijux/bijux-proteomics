...
Installation for `bijux-proteomics-lab` should start from the package metadata and the specific
...
flowchart LR
    ...
    page["bijux-proteomics-lab<br/>installation and setup"]
    op1["operators"]
...
- metadata file: `packages/bijux-proteomics-lab/pyproject.toml`
- readme: `packages/bijux-proteomics-lab/README.md`
