...
Security review in `bijux-proteomics-lab` should focus on the package's real boundary surfaces and outputs.
...
flowchart LR
    ...
    page["bijux-proteomics-lab<br/>security and safety"]
