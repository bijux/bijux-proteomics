...
This package exists where recommendations meet real assay work and outcomes. It should stay specific to lab-facing decisions rather than absorb generic runtime control.
