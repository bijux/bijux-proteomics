...
flowchart TB
    ...
    surface1["CLI entrypoint in src/bijux_proteomics_lab/planning.py"]
    surface1 --> page
    surface2["HTTP app in src/bijux_proteomics_lab/outcomes.py"]
    surface2 --> page
    surface3["lab contracts in src/bijux_proteomics_lab/schema.py"]
    surface3 --> page
