...
```mermaid
flowchart LR
    contract1["batch plans"]
    contract2["execution outputs"]
    contract3["promotion decisions"]
    page["bijux-proteomics-lab<br/>compatibility commitments"]
    proof1["package code"]
    proof2["tests"]
    proof3["workflow examples"]
