...
flowchart LR
    ...
    surface1["HTTP app in src/bijux_proteomics_lab/outcomes.py"]
    surface1 --> page
    surface2["lab contracts in src/bijux_proteomics_lab/schema.py"]
    surface2 --> page
    surface3["CLI entrypoint in src/bijux_proteomics_lab/planning.py"]
    surface3 --> page
...
- interface modules: CLI entrypoint in src/bijux_proteomics_lab/planning.py, HTTP app in src/bijux_proteomics_lab/outcomes.py, lab contracts in src/bijux_proteomics_lab/schema.py
