...
flowchart RL
    ...
    surface1["lab contracts in src/bijux_proteomics_lab/schema.py"]
    surface1 --> page
    surface2["CLI entrypoint in src/bijux_proteomics_lab/planning.py"]
    surface2 --> page
    surface3["HTTP app in src/bijux_proteomics_lab/outcomes.py"]
    surface3 --> page
