...
flowchart RL
    ...
    step1["HTTP app in src/bijux_proteomics_foundation/api/v1"]
    step1 --> page
    step2["packages/bijux-proteomics-foundation/pyproject.toml"]
    step2 --> page
    step3["CLI entrypoint in src/bijux_proteomics_foundation/interfaces/cli/entrypoint.py"]
    step3 --> page
...
- version file: `packages/bijux-proteomics-foundation/src/bijux_proteomics_foundation/_version.py`
- tag pattern is configured in `packages/bijux-proteomics-foundation/pyproject.toml`
