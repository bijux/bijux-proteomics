...
flowchart TB
    ...
    step1 --> page
    step2["CLI entrypoint in src/bijux_proteomics_foundation/interfaces/cli/entrypoint.py"]
    step2 --> page
    step3["HTTP app in src/bijux_proteomics_foundation/api/v1"]
    step3 --> page
...
- interface surfaces: CLI entrypoint in src/bijux_proteomics_foundation/interfaces/cli/entrypoint.py, HTTP app in src/bijux_proteomics_foundation/api/v1, schema files in api/bijux-proteomics-foundation/v1
