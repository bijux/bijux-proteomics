...
- interface modules: CLI entrypoint in src/bijux_proteomics_foundation/interfaces/cli/entrypoint.py, HTTP app in src/bijux_proteomics_foundation/api/v1, schema files in api/bijux-proteomics-foundation/v1
