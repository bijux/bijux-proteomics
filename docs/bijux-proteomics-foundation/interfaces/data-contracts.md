...
flowchart RL
    ...
    surface1["schema files in api/bijux-proteomics-foundation/v1"]
    surface1 --> page
    surface2["CLI entrypoint in src/bijux_proteomics_foundation/interfaces/cli/entrypoint.py"]
    surface2 --> page
    surface3["HTTP app in src/bijux_proteomics_foundation/api/v1"]
    surface3 --> page
    proof1["execution store records"]
    page --> proof1
    proof2["api/bijux-proteomics-foundation/v1/schema.yaml"]
    page --> proof2
    proof3["api/bijux-proteomics-foundation/v1/schema.hash"]
    page --> proof3
