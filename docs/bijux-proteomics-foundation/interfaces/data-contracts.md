...
flowchart RL
    ...
    surface1["schema contracts in src/bijux_proteomics_foundation/schema.py"]
    surface1 --> page
    surface2["CLI entrypoint in src/bijux_proteomics_foundation/__init__.py"]
    surface2 --> page
    surface3["HTTP app in src/bijux_proteomics_foundation/schema.py"]
    surface3 --> page
