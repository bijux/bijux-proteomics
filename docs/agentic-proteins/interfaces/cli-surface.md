...
flowchart LR
    ...
    surface3 --> page
    proof1["api/agentic-proteins/v1/schema.yaml"]
    page --> proof1
    proof2["api/agentic-proteins/v1/schema.hash"]
    page --> proof2
...
- interface modules: CLI entrypoint in src/agentic_proteins/interfaces/cli/entrypoint.py, HTTP app in src/agentic_proteins/api/v1, schema files in api/agentic-proteins/v1
