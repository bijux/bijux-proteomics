...
Dependencies and adjacencies explain what `agentic-proteins` can do by itself and
...
```mermaid
flowchart LR
    dep1["legacy caller expectations"]
    dep2["runtime release changes"]
    dep3["migration pressure"]
    pkg["agentic-proteins<br/>dependency and adjacency view"]
