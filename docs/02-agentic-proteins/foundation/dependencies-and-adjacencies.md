...
`agentic-proteins` should depend on neighboring packages only in ways that strengthen
its role as compatibility forwarding. Adjacency is acceptable when it clarifies handoff and
...
- the imports and public contracts in `packages/agentic-proteins`
