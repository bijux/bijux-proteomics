...
Reviewing changes in `agentic-proteins` should include both behavior and documentation.
...
flowchart LR
    ...
    page["agentic-proteins<br/>review checklist"]
...
Use `Review Checklist` to decide whether `agentic-proteins` has actually earned trust after a change. If one narrow green check hides a wider contract, risk, or validation gap, the work is not done yet.
