...
Evidence uses [packages/agentic-proteins/tests/unit/agents/test_protein_system_rigidity.py](https://github.com/bijux/bijux-proteomics/blob/main/packages/agentic-proteins/tests/unit/agents/test_protein_system_rigidity.py).  
