...
Contracts align with [tests/api/test_run.py](https://github.com/bijux/bijux-proteomics/blob/main/tests/api/test_run.py).  
Contracts link to [Cli](../cli/cli.md) and [Docs Style](../meta/DOCS_STYLE.md).  

## Invariants  
Invariants describe stable behavior.  
Checks align with [tests/api/test_run.py](https://github.com/bijux/bijux-proteomics/blob/main/tests/api/test_run.py).  
Invariants align with [Cli](../cli/cli.md).  

## Failure Modes  
Failures are explicit and tested.  
Failure coverage aligns with [tests/api/test_run.py](https://github.com/bijux/bijux-proteomics/blob/main/tests/api/test_run.py).  
...
Extensions align with [tests/api/test_run.py](https://github.com/bijux/bijux-proteomics/blob/main/tests/api/test_run.py).  
...
Code refs: [tests/api/test_run.py](https://github.com/bijux/bijux-proteomics/blob/main/tests/api/test_run.py).  
