...
| `lfq` | outsider-auditable, bounded | `raw_executable` | flagship package plus companion generalization package | generalization beyond the current cohort package stays explicitly bounded | [Why Trust LFQ](https://bijux.io/bijux-proteomics/01-bijux-proteomics/foundation/why-trust-lfq/) |
