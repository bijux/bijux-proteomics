...
This page names the line that keeps `bijux-proteomics-knowledge` useful instead of bloated.
...
Update it only when ownership truly moves into or out of `bijux-proteomics-knowledge`.
