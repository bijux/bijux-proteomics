...
Ownership in `bijux-proteomics-knowledge` should be visible in checked-in structure, not
...
flowchart LR
    ...
    boundary["Ownership boundary<br/>for bijux-proteomics-knowledge"]
