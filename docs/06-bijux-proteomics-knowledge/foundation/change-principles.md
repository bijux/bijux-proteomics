...
```mermaid
flowchart LR
    driver1["keep evidence inspectable"]
    driver2["separate fact from policy"]
    driver3["treat trust regressions as serious"]
    pkg["bijux-proteomics-knowledge<br/>change principles"]
