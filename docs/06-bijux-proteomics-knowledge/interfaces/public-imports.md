...
The public Python surface of `bijux-proteomics-knowledge` starts at the package import root and any
...
The interface pages define what `bijux-proteomics-knowledge` is prepared to defend before a dependency forms.
...
flowchart LR
    surf1["evidence APIs"]
    surf2["claim schemas"]
    surf3["review artifacts"]
    page["bijux-proteomics-knowledge<br/>public imports"]
    caller1["intelligence readers"]
    caller2["runtime status surfaces"]
    caller3["scientific reviewers"]
...
- package source root: `packages/bijux-proteomics-knowledge/src/bijux_proteomics_knowledge`
