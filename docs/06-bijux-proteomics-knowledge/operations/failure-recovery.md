...
flowchart LR
    ...
    page["bijux-proteomics-knowledge<br/>failure recovery"]
...
- interface surfaces: CLI entrypoint in src/bijux_proteomics_knowledge/evidence.py, HTTP app in src/bijux_proteomics_knowledge/claims.py, knowledge contracts in src/bijux_proteomics_knowledge/schema.py
