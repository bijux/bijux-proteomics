...
- local setup should focus on evidence fixtures, contradiction cases, and persistence proof
- use review-heavy scenarios rather than only clean canonical records
- keep runtime deployment detail outside the local knowledge review loop
