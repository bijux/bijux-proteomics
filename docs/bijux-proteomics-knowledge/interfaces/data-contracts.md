...
flowchart RL
    ...
    surface1["schema files in api/bijux-proteomics-knowledge/v1"]
    surface1 --> page
    surface2["CLI entrypoint in src/bijux_proteomics_knowledge/interfaces/cli/entrypoint.py"]
    surface2 --> page
    surface3["HTTP app in src/bijux_proteomics_knowledge/api/v1"]
    surface3 --> page
