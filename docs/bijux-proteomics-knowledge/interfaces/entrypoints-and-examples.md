...
flowchart TB
    ...
    surface1["CLI entrypoint in src/bijux_proteomics_knowledge/interfaces/cli/entrypoint.py"]
    surface1 --> page
    surface2["HTTP app in src/bijux_proteomics_knowledge/api/v1"]
    surface2 --> page
    surface3["schema files in api/bijux-proteomics-knowledge/v1"]
    surface3 --> page
    proof1["api/bijux-proteomics-knowledge/v1/schema.hash"]
    page --> proof1
    proof2["execution store records"]
    page --> proof2
    proof3["api/bijux-proteomics-knowledge/v1/schema.yaml"]
    page --> proof3
...
- api/bijux-proteomics-knowledge/v1/schema.hash for schema integrity checks
