...
Deployment for `bijux-proteomics-knowledge` should respect the package boundary instead of assuming the full repository is always present.
...
flowchart TB
    ...
    step1 --> page
    step2["CLI entrypoint in src/bijux_proteomics_knowledge/interfaces/cli/entrypoint.py"]
    step2 --> page
    step3["HTTP app in src/bijux_proteomics_knowledge/api/v1"]
    step3 --> page
...
- package root: `packages/bijux-proteomics-knowledge`
- public metadata: `packages/bijux-proteomics-knowledge/pyproject.toml`
- release notes: `packages/bijux-proteomics-knowledge/CHANGELOG.md` when present
