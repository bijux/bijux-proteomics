...
- interface surfaces: CLI entrypoint in src/bijux_proteomics_knowledge/interfaces/cli/entrypoint.py, HTTP app in src/bijux_proteomics_knowledge/api/v1, schema files in api/bijux-proteomics-knowledge/v1
