...
Installation for `bijux-proteomics-knowledge` should start from the package metadata and the specific
...
- metadata file: `packages/bijux-proteomics-knowledge/pyproject.toml`
- readme: `packages/bijux-proteomics-knowledge/README.md`
