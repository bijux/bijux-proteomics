...
```mermaid
flowchart LR
    cap1["candidate ranking"]
    cap2["scenario evaluation"]
    cap3["explainable recommendation policy"]
    pkg["bijux-proteomics-intelligence<br/>capability map"]
    use1["bijux-proteomics-knowledge"]
    use2["bijux-proteomics-core"]
    use3["bijux-proteomics-lab"]
