...
Dependencies and adjacencies explain what `bijux-proteomics-intelligence` can do by itself and
...
flowchart RL
    ...
    anchor1["packages/bijux-proteomics-intelligence"]
    page --> anchor1
    anchor2["packages/bijux-proteomics-intelligence/src/bijux_proteomics_intelligence"]
    page --> anchor2
    anchor3["packages/bijux-proteomics-intelligence/tests"]
    page --> anchor3
    class page page;
...
This page explains which surrounding tools and packages `bijux-proteomics-intelligence` depends on to do its job.
