...
The language around `bijux-proteomics-intelligence` should reinforce the real package
...
```mermaid
flowchart LR
    term1["ranking policy"]
    term2["scenario score"]
    term3["explanation output"]
    pkg["bijux-proteomics-intelligence<br/>domain language"]
    reader1["reviewers"]
    reader2["developers"]
    reader3["maintainers"]
...
- package name: `bijux-proteomics-intelligence`
- Python import root: `bijux_proteomics_intelligence`
- owning package directory: `packages/bijux-proteomics-intelligence`
