...
Changes in `bijux-proteomics-intelligence` should leave the package easier to explain, not
...
```mermaid
flowchart LR
    driver1["keep scoring inspectable"]
    driver2["separate policy from contracts"]
    driver3["trace recommendation drift"]
    pkg["bijux-proteomics-intelligence<br/>change principles"]
