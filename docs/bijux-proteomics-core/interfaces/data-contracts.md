...
flowchart RL
    ...
    surface1["program schemas in src/bijux_proteomics/programs.py"]
    surface1 --> page
    surface2["CLI entrypoint in src/bijux_proteomics/interfaces/cli.py"]
    surface2 --> page
    surface3["HTTP app in src/bijux_proteomics/programs.py"]
    surface3 --> page
