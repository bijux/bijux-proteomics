...
Data contracts in `bijux-proteomics-core` include schemas, structured models, and any stable
...
flowchart RL
    ...
    surface1["schema files in api/bijux-proteomics-core/v1"]
    surface1 --> page
    surface2["CLI entrypoint in src/bijux_proteomics/interfaces/cli/entrypoint.py"]
    surface2 --> page
    surface3["HTTP app in src/bijux_proteomics/api/v1"]
    surface3 --> page
    proof1["execution store records"]
    page --> proof1
    proof2["api/bijux-proteomics-core/v1/schema.yaml"]
    page --> proof2
    proof3["api/bijux-proteomics-core/v1/schema.hash"]
    page --> proof3
...
- api/bijux-proteomics-core/v1/schema.hash
