...
Deployment for `bijux-proteomics-core` should respect the package boundary instead of assuming the full repository is always present.
...
flowchart TB
    ...
    step1 --> page
    step2["CLI entrypoint in src/bijux_proteomics/interfaces/cli/entrypoint.py"]
    step2 --> page
    step3["HTTP app in src/bijux_proteomics/api/v1"]
    step3 --> page
...
- package root: `packages/bijux-proteomics-core`
- public metadata: `packages/bijux-proteomics-core/pyproject.toml`
- release notes: `packages/bijux-proteomics-core/CHANGELOG.md` when present
