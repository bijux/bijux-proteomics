...
Diagnostics should make it easier to explain what `bijux-proteomics-core` did, not merely that it ran.
...
flowchart LR
    ...
    step1["CLI entrypoint in src/bijux_proteomics/interfaces/cli.py"]
    step1 --> page
    step2["HTTP app in src/bijux_proteomics/programs.py"]
    step2 --> page
