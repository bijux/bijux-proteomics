...
Installation for `bijux-proteomics-core` should start from the package metadata and the specific
...
- metadata file: `packages/bijux-proteomics-core/pyproject.toml`
- readme: `packages/bijux-proteomics-core/README.md`
