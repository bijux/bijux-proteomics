...
The public Python surface of `bijux-proteomics-lab` starts at the package import root and any
...
- package source root: `packages/bijux-proteomics-lab/src/bijux_proteomics_lab`
