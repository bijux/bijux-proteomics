...
The CLI surface is the operator-facing command layer for `bijux-proteomics-lab`. It
...
flowchart LR
    ...
    surface1["HTTP app in src/bijux_proteomics_lab/api/v1"]
    surface1 --> page
    surface2["schema files in api/bijux-proteomics-lab/v1"]
    surface2 --> page
    surface3["CLI entrypoint in src/bijux_proteomics_lab/interfaces/cli/entrypoint.py"]
    surface3 --> page
    proof1["api/bijux-proteomics-lab/v1/schema.yaml"]
    page --> proof1
    proof2["api/bijux-proteomics-lab/v1/schema.hash"]
    page --> proof2
...
- canonical command: `bijux-proteomics-lab`
- interface modules: CLI entrypoint in src/bijux_proteomics_lab/interfaces/cli/entrypoint.py, HTTP app in src/bijux_proteomics_lab/api/v1, schema files in api/bijux-proteomics-lab/v1
