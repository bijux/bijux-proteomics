...
flowchart TB
    ...
    surface1["CLI entrypoint in src/bijux_proteomics_lab/interfaces/cli/entrypoint.py"]
    surface1 --> page
    surface2["HTTP app in src/bijux_proteomics_lab/api/v1"]
    surface2 --> page
    surface3["schema files in api/bijux-proteomics-lab/v1"]
    surface3 --> page
    proof1["api/bijux-proteomics-lab/v1/schema.hash"]
    page --> proof1
    proof2["execution store records"]
    page --> proof2
    proof3["api/bijux-proteomics-lab/v1/schema.yaml"]
    page --> proof3
...
- entry surfaces: CLI entrypoint in src/bijux_proteomics_lab/interfaces/cli/entrypoint.py, HTTP app in src/bijux_proteomics_lab/api/v1, schema files in api/bijux-proteomics-lab/v1
