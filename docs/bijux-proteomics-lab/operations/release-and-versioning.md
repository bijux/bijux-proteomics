...
flowchart RL
    ...
    step1["Planning and outcomes models in src/bijux_proteomics_lab/"]
    step1 --> page
    step2["packages/bijux-proteomics-lab/pyproject.toml"]
    step2 --> page
    step3["Lab repository contracts in src/bijux_proteomics_lab/repositories.py"]
    step3 --> page
    run1["tests/ for planning and scheduling behavior"]
    page --> run1
    run2["outcome promotion and rerun recommendation checks in tests/"]
    page --> run2
    run3["cross-package lab contract checks in tests/"]
    page --> run3
