...
flowchart RL
    ...
    step1["HTTP app in src/bijux_proteomics_lab/api/v1"]
    step1 --> page
    step2["packages/bijux-proteomics-lab/pyproject.toml"]
    step2 --> page
    step3["CLI entrypoint in src/bijux_proteomics_lab/interfaces/cli/entrypoint.py"]
    step3 --> page
...
- version file: `packages/bijux-proteomics-lab/src/bijux_proteomics_lab/_version.py`
- tag pattern is configured in `packages/bijux-proteomics-lab/pyproject.toml`
