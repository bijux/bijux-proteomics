...
Release work for `bijux-proteomics-intelligence` depends on package metadata, tracked release notes, and
...
flowchart RL
    ...
    step1["HTTP app in src/bijux_proteomics_intelligence/api/v1"]
    step1 --> page
    step2["packages/bijux-proteomics-intelligence/pyproject.toml"]
    step2 --> page
    step3["CLI entrypoint in src/bijux_proteomics_intelligence/interfaces/cli/entrypoint.py"]
    step3 --> page
