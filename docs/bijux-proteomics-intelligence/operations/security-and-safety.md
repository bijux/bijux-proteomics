...
Security review in `bijux-proteomics-intelligence` should focus on the package's real boundary surfaces and outputs.
...
flowchart LR
    ...
    step1["CLI entrypoint in src/bijux_proteomics_intelligence/interfaces/cli/entrypoint.py"]
    step1 --> page
    step2["HTTP app in src/bijux_proteomics_intelligence/api/v1"]
    step2 --> page
