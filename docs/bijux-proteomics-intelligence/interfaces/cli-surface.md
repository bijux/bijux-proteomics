...
The CLI surface is the operator-facing command layer for `bijux-proteomics-intelligence`. It
...
flowchart LR
    ...
    surface3 --> page
    proof1["api/bijux-proteomics-intelligence/v1/schema.yaml"]
    page --> proof1
    proof2["api/bijux-proteomics-intelligence/v1/schema.hash"]
    page --> proof2
...
- canonical command: `bijux-proteomics-intelligence`
- interface modules: CLI entrypoint in src/bijux_proteomics_intelligence/interfaces/cli/entrypoint.py, HTTP app in src/bijux_proteomics_intelligence/api/v1, schema files in api/bijux-proteomics-intelligence/v1
