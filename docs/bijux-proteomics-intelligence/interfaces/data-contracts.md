...
flowchart RL
    ...
    surface1["schema files in api/bijux-proteomics-intelligence/v1"]
    surface1 --> page
    surface2["CLI entrypoint in src/bijux_proteomics_intelligence/interfaces/cli/entrypoint.py"]
    surface2 --> page
    surface3["HTTP app in src/bijux_proteomics_intelligence/api/v1"]
    surface3 --> page
...
- api/bijux-proteomics-intelligence/v1/schema.hash
