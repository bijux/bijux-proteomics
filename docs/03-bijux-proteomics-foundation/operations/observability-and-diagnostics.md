...
Diagnostics make it easier to explain what `bijux-proteomics-foundation` did, not merely that it ran.
...
flowchart LR
    ...
    page["bijux-proteomics-foundation<br/>observability and diagnostics"]
...
This page shows how `bijux-proteomics-foundation` is operated today, but the checked-in commands, artifacts, and validation remain the source of truth. Use those assets to confirm the workflow in a real environment.
