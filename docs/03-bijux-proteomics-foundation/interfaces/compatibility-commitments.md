...
```mermaid
flowchart LR
    contract1["payload shape"]
    contract2["serialization guarantees"]
    contract3["identifier stability"]
    page["bijux-proteomics-foundation<br/>compatibility commitments"]
    proof1["package code"]
    proof2["schema files"]
    proof3["compatibility tests"]
